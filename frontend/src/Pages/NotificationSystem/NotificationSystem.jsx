...
const NotificationDashboard = ({
  ...
  return (
    <div className="notification-dashboard">
      ...
      {/* STAT CARDS – dùng dữ liệu thực từ backend */}
            ...
            <tbody>
              {loading ? (
                ...
                notifications.map((item) => {
                  // Backend trả về field `read` (theo NotificationPayload),
                  // nhưng nếu lỡ có `isRead` thì vẫn fallback cho chắc.
...
const NotificationSystem = () => {
  ...
  // Lấy thông báo + số chưa đọc từ backend khi mở trang
  useEffect(() => {
